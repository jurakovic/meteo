...
;const i=e.getAttribute("data-slideshow-id");e.querySelectorAll("img").forEach((e=>{e.addEventListener("dragstart",(e=>e.preventDefault()))
...
const e=o-t,a=s-n;Math.abs(e)>Math.abs(a)&&handleSwipe(i,t,o)}})),e.addEventListener("mousedown",(e=>{t=e.clientX,n=e.clientY,a=!0})),
e.addEventListener("mousemove",(e=>{a&&(o=e.clientX,s=e.clientY)})),e.addEventListener("mouseup",(e=>{if(a){o=e.clientX,s=e.clientY
;const r=o-t,l=s-n;Math.abs(r)>Math.abs(l)&&handleSwipe(i,t,o),a=!1}})),e.addEventListener("mouseleave",(()=>{a&&(a=!1)}))}))}
...
;let n=e.getAttribute("data-src"),o=t.getAttribute("data-src");window.innerWidth<800&&(n=n.replace("&zoom=7","&zoom=6"),
o=o.replace("#6/","#5/")),e.src=n,t.src=o,previousWidth=window.innerWidth}}function hideOverlayOnDoubleTap(){
document.querySelectorAll(".if1 .overlay").forEach((e=>{let t=0;e.addEventListener("dblclick",(()=>{e.style.display="none"})),
e.addEventListener("touchend",(n=>{const o=(new Date).getTime(),s=o-t;s>0&&s<200&&(e.style.display="none",n.preventDefault()),t=o}))
;const n=e.querySelector(".hint");let o=0,s=0;e.addEventListener("touchstart",(e=>{1===e.touches.length&&(s=e.touches[0].clientX,
o=e.touches[0].clientY)})),e.addEventListener("touchend",(e=>{if(!n)return
;const t=e.changedTouches[0].clientX,a=e.changedTouches[0].clientY,i=Math.abs(t-s),r=Math.abs(a-o);i<10&&r<10&&(n.style.opacity="0.6",
...
let[e,t]=GetLastInit(),n=`https://www.stormforecast.eu/map_images/models/archamos/${e.slice(0,6)}/${e}/combi_paramcombi24_${e}_${t}.png`
;const o=document.getElementById("essl");o.src=n,o.addEventListener("error",(()=>{var e=document.createElement("span")
;e.innerHTML="Nema prognoze za traženi period",o.parentNode.appendChild(e)}))}function GetLastInit(){let e=new Date,t=new Date
;e.getUTCHours()>=20?(dlog("b1: dt.getUTCHours() >= 20"),e.setUTCHours(12,0,0,0),t=new Date(e.getTime()),
t.setDate(t.getDate()+3)):e.getUTCHours()>=10&&e.getUTCHours()<20?(dlog("b2: dt.getUTCHours() >= 10 && dt.getUTCHours() < 20"),
e.setUTCHours(0,0,0,0),t=new Date(e.getTime()),t.setDate(t.getDate()+2)):e.getUTCHours()<10&&(dlog("b3: dt.getUTCHours() < 10"),
e.setUTCHours(12,0,0,0),e.setDate(e.getDate()-1),t=new Date(e.getTime()),t.setDate(t.getDate()+3));let n=DTGFromDateInHours(e),o=EndValue(t)
;return dlog("dt:  "+e),dlog("dte: "+t),dlog("dtg: "+n),dlog("end: "+o),[n,o]}function DTGFromDateInHours(e){
