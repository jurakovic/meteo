...
setIframeSrc("meteoblueZg"),setIframeSrc("meteoblueSt"),setIframeSrc("meteoblueRi"),setIframeSrc("meteoblueOs"))}function setIframeSrc(e){
dlog(`Updating iframe src for ${e}`);const t=document.getElementById(e);if(t){let o=zoomMap.get(e),n=t.getAttribute("data-src")
;if(o&&o.length>0){let e=o[0],t=o[1];window.innerWidth<800&&(n=n.replace(e,t))}t.src=n
}else dlog(`${e} not found, skipping updateIframeSrc for ${e}`)}function hideOverlayOnDoubleTap(){
document.querySelectorAll(".overlay").forEach(e=>{let t=0;e.addEventListener("dblclick",()=>{e.style.display="none"
...
const e=window.innerWidth<800;document.querySelectorAll(".hint").forEach(t=>{const o="map"==t.getAttribute("data-type")?"karti":"grafici"
;t.textContent=e?`Dvostruki dodir za pristup interaktivnoj ${o}`:`Dvostruki klik za pristup interaktivnoj ${o}`})}
