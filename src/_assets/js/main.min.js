...
})),e.addEventListener("error",(()=>{o++,e.removeAttribute("src"),n()})),e.complete&&e.dispatchEvent(new Event("load"))}))}
function handleSwipe(e,t,o){const n=o-t;Math.abs(n)>50&&plusSlides(e,n>0?-1:1)}function addSwipeEvents(){
document.querySelectorAll(".slideshow").forEach((e=>{let t=0,o=0,n=0,s=0,a=!1;const l=e.getAttribute("data-slideshow-id")
;e.querySelectorAll("img").forEach((e=>{e.addEventListener("dragstart",(e=>e.preventDefault()))})),e.addEventListener("touchstart",(e=>{
t=e.touches[0].clientX,o=e.touches[0].clientY,a=!1})),e.addEventListener("touchmove",(e=>{n=e.touches[0].clientX,s=e.touches[0].clientY,
Math.abs(n-t)>Math.abs(s-o)&&(a=!0)})),e.addEventListener("touchend",(()=>{if(a){const e=n-t,a=s-o
;Math.abs(e)>Math.abs(a)&&handleSwipe(l,t,n)}})),e.addEventListener("mousedown",(e=>{t=e.clientX,o=e.clientY,a=!0})),
e.addEventListener("mousemove",(e=>{a&&(n=e.clientX,s=e.clientY)})),e.addEventListener("mouseup",(e=>{if(a){n=e.clientX,s=e.clientY
;const i=n-t,r=s-o;Math.abs(i)>Math.abs(r)&&handleSwipe(l,t,n),a=!1}})),e.addEventListener("mouseleave",(()=>{a&&(a=!1)}))}))}
...
;const t=e.changedTouches[0].clientX,a=e.changedTouches[0].clientY,l=Math.abs(t-s),i=Math.abs(a-n);l<10&&i<10&&(o.style.opacity="0.6",
...
console.log("new: "+o);const n=document.getElementById("essl");n.src=o,n.addEventListener("error",(()=>{var e=document.createElement("span")
;e.innerHTML="Nema prognoze za traženi period",n.parentNode.appendChild(e)}))}function GetLastInit(){let e=new Date,t=new Date
;e.getUTCHours()>=20?(console.log("d1"),e.setUTCHours(12,0,0,0),t=new Date(e.getTime()),
t.setDate(t.getDate()+3)):e.getUTCHours()>=10&&e.getUTCHours()<20?(console.log("d2"),e.setUTCHours(0,0,0,0),t=new Date(e.getTime()),
t.setDate(t.getDate()+2)):e.getUTCHours()<10&&(console.log("d3"),e.setUTCHours(12,0,0,0),e.setDate(e.getDate()-1),t=new Date(e.getTime()),
t.setDate(t.getDate()+3)),console.log(e),console.log(t),console.log(10),console.log(20);let o=DTGFromDateInHours(e),n=EndValue(t)
