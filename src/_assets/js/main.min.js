...
function addSwipeEvents(){document.querySelectorAll(".slideshow").forEach((e=>{let t=0,n=0,o=0,s=0,r=!1
...
})),e.addEventListener("touchstart",(e=>{t=e.touches[0].clientX,n=e.touches[0].clientY,r=!1})),e.addEventListener("touchmove",(e=>{
o=e.touches[0].clientX,s=e.touches[0].clientY,Math.abs(o-t)>Math.abs(s-n)&&(r=!0)})),e.addEventListener("touchend",(()=>{if(r){
const e=o-t,r=s-n;Math.abs(e)>Math.abs(r)&&handleSwipe(a,t,o)}})),e.addEventListener("mousedown",(e=>{t=e.clientX,n=e.clientY,r=!0})),
e.addEventListener("mousemove",(e=>{r&&(o=e.clientX,s=e.clientY)})),e.addEventListener("mouseup",(e=>{if(r){o=e.clientX,s=e.clientY
;const i=o-t,l=s-n;Math.abs(i)>Math.abs(l)&&handleSwipe(a,t,o),r=!1}})),e.addEventListener("mouseleave",(()=>{r&&(r=!1)}))}))}
...
;const t=document.getElementById("windyFrame"),n=document.getElementById("blitzortungFrame"),o=document.getElementById("weatherAndRadarFrame"),s=document.getElementById("rainViewerFrame"),r=document.getElementById("ventusskyFrame")
;e(t,"&zoom=7","&zoom=6"),e(n,"#6/","#5/"),e(o,"&zoom=7.2","&zoom=6.8"),e(s,",6.3&",",5.8&"),e(r,";6&",";6&")}}
...
;const t=e.changedTouches[0].clientX,r=e.changedTouches[0].clientY,a=Math.abs(t-s),i=Math.abs(r-o);a<10&&i<10&&(n.style.opacity="0.6",
...
function setEsslImgSrc(e=1){const t=document.getElementById("essl");if(!t)return void dlog("essl img not found, skipping setEsslImgSrc")
;let n=GetLastInit();e>1&&n.setUTCHours(n.getUTCHours()-12*e)
;let o=new Date(Date.UTC(n.getUTCFullYear(),n.getUTCMonth(),n.getUTCDate()+(12===n.getUTCHours()?3:2),0,0,0,0)),s=DTGFromDateInHours(n),r=EndValue(o)
;dlog("dtg: "+s),dlog("end: "+r)
;let a=`https://www.stormforecast.eu/map_images/models/archamos/${s.slice(0,6)}/${s}/combi_paramcombi24_${s}_${r}.png`;function i(){
