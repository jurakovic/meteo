...
updateSlideshowWidth(e)}function updateSlideshowWidth(e){if(16!==e)return
...
o=e.touches[0].clientY,s=!1})),e.addEventListener("touchmove",(e=>{n=e.touches[0].clientX,r=e.touches[0].clientY,
Math.abs(n-t)>Math.abs(r-o)&&(s=!0)})),e.addEventListener("touchend",(()=>{if(s){const e=n-t,s=r-o
;Math.abs(e)>Math.abs(s)&&handleSwipe(a,t,n)}})),e.addEventListener("mousedown",(e=>{t=e.clientX,o=e.clientY,s=!0})),
